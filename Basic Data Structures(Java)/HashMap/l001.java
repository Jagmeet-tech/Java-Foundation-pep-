...
public class l001{
    ...
    public static void intersectionOfTwoArrayWithoutDuplicates(int[] arr1, int[] arr2) {  //getCommonEle1
    ...
    public static void intersectionOfTwoArrayWithDuplicates(int[] arr1, int[] arr2) {   ////getCommonEle2
        HashMap<Integer, Integer> map = new HashMap<>();
        for (int ele : arr1) {
            map.put(ele, map.getOrDefault(ele, 0) + 1);
        }
